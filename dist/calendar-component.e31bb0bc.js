...
var isTodayClass = function isTodayClass(currentDate, today) {
  return currentDate == today.split("-")[2];
};

exports.isTodayClass = isTodayClass;

var isThisMonthClass = function isThisMonthClass(currentDate, today) {
  return currentDate == today;
};

exports.isThisMonthClass = isThisMonthClass;

var calendarDayClass = function calendarDayClass(_ref3) {
