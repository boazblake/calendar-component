...
},{"../toDate/index.js":"node_modules/date-fns/esm/toDate/index.js","../_lib/requiredArgs/index.js":"node_modules/date-fns/esm/_lib/requiredArgs/index.js"}],"node_modules/date-fns/esm/getWeekOfMonth/index.js":[function(require,module,exports) {
"use strict";
...
var convertDate = function convertDate(day, _ref) {
  var isSameMonth = _ref.isSameMonth;
  return isSameMonth ? (0, _format.default)(day, "dd") : "--";
};
...
var getModelDto = function getModelDto() {
  var date = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : new Date().toISOString().split("T")[0];
  ...
  var year = _date[0];
  var month = _date[1];
  var week = (0, _getWeekOfMonth.default)(_date);
  var day = _date[2];
  var dto = {
    selectedDate: date,
    ...
    view: function view(_ref3) {
      ...
      return (0, _mithril.default)(".toolbar", [(0, _mithril.default)("input", {
        onchange: function onchange(e) {
          return mdl.data = getModelDto(e.target.value);
        },
        type: "date",
...
var calendarDayClass = function calendarDayClass(_ref4) {
  ...
  return function (currentDate) {
    ...
    if (currentDate == today.split("-")[2] && currentDate == day) {
      ...
      return "isSelected";
    } else if (currentDate == today.split("-")[2] && month == today.split("-")[1]) {
      return "isToday";
    }
  };
};
...
var Calendar = function Calendar() {
  return {
    view: function view(_ref5) {
      ...
      var dto = getMountMatrix(mdl.data);
      return (0, _mithril.default)(".frow frow-container", [(0, _mithril.default)(".frow width-100 row-between mt-10", daysOfTheWeek.map(function (day) {
        ...
        return (0, _mithril.default)(".frow width-100", {
          ...
          return (0, _mithril.default)(".col-xs-1-7 text-center", {
            onclick: function onclick(_) {
              return mdl.data = getModelDto("".concat(mdl.data.year, "-").concat(mdl.data.month, "-").concat(day));
            },
            class: // console.log(
...
//# sourceMappingURL=/calendar.e31bb0bc.js.map